    ...
    <Card className='p-3'>
      ...
      <Card.Body>
        <div className='d-flex flex-column'>
          <div className='mb-4 text-primary fs-3 d-flex flex-row align-items-center'>
            <div className='fs-2 mt-1 mr-3'>
              <span>
                CLIENTE:
              </span>
                <br/>
            ...
            <div>
              <span className='fs-1'>
                <span className='text-black fs-1'> {item.nombre_cliente}</span> 
              </span>
              <br/>
              <span className='fs-2'>
              <span className='text-black'>
                <span className='text-primary'>
                  <DateMask date={item?.fecha_venta} format={'dddd DD [de] MMMM'} />
                </span>
                  <DateMask date={item?.fecha_venta} format={' [DEL] YYYY [a las] hh:mm A'} /></span>
              </span>
            </div>
          ...
          <div>
            <Table striped bordered>
              ...
              <tbody>
                ...
                <tr>
                  <td></td><td></td><td></td>
                  <td className='m-0 p-0 bg-greenISESAC'><div className='text-white fs-1 text-center m-0 p-0'>TOTAL</div></td>
          ...
          <div>
            <Row>
              <Col lg={4}>
                <div className='d-flex flex-column'>
                  <Button className='m-2 border border-color-ISESAC border-3' label={<div className='text-left'><span className='fs-3 text-ISESAC mr-2'>AGREGAR</span> <span className='fs-2 text-black'>PRODUCTO</span></div>} onClick={() => onOpenModalCustomProdComanda(item.id)} text/>
                  <Button className='m-2 border border-color-ISESAC border-3' label={<div className='text-left'><span className='fs-3 text-ISESAC mr-2'>AGREGAR</span> <span className='fs-2 text-black'>SERVICIO</span></div>} onClick={() => onOpenModalCustomServComanda(item.id)} text/>
                </div>
              </Col>
              <Col lg={8}>
