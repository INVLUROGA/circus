...
for (const p of getDetalleProductos(v)) {
  ...
  const rows = [
    // --- TOTAL: En Soles (PEN) ---
    { key: "invTotalPEN", label: "INVERSIÓN TOTAL REDES", type: "money" }, // money = S/
    { key: "leadsTotal",  label: "TOTAL LEADS DE META + TIKTOK", type: "int" },
    { key: "cplTotal",    label: "COSTO TOTAL POR LEADS DE META + TIKTOK", type: "float2" }, // S/
    { key: "cacTotal",    label: "COSTO ADQUISICION DE CLIENTES", type: "float2" }, // S/

    // --- META: En Dólares (USD) ---
    { key: "invMetaPEN",  label: "INVERSIÓN META", type: "money-usd"  }, // money-usd = $
    ...
    // --- TIKTOK: En Soles (PEN) ---
    { key: "invTikTokPEN",label: "INVERSIÓN TIKTOK", type: "money"  }, // money = S/
    { key: "leadsTikTok", label: "CANTIDAD LEADS TIKTOK", type: "int"    },
    { key: "cplTikTok",   label: "COSTO POR LEAD TIKTOK", type: "float2" }, // S/
    { key: "cacTikTok",   label: "COSTO ADQUISICION DE CLIENTES TIKTOK", type: "float2" }, // S/
