  ...
  return (
    <div>
      ...
      {/* <div className="w-full bg-black text-white">
        ...
        <div className="md:col-span-2 text-center md:text-right fs-2 font-semibold leading-snug">
        {title}
          </div>
        </div>
      </div> */}
      ...
      <div className="overflow-x-auto bg-white shadow-2xl rounded-b-2xl ring-1 ring-black/10">
        <table className="w-full table-fixed border-collapse">
          <thead>
            <tr>
              <th className="bg-yellow-400 text-black border border-black px-3 text-left uppercase font-extrabold fs-3">
                <div className="">
                  MES
                </div>
              </th>
              {columns.map((c) => (
                <th
                  key={c.key}
                  className="bg-yellow-400 text-black border border-black px-3 text-left uppercase font-extrabold fs-3"
                >
                  <div className="">
          ...
          <tfoot>
            <tr>
              <td className="bg-yellow-400 text-black border border-black py-2 fs-3">
              ...
              {columns.map((c) => (
                <td
                  key={c.key}
                  className="fs-2 bg-yellow-400 text-black border border-black pl-4 text-right font-extrabold"
                >
