...
const GRID_SUMMARY = `repeat(${DAYS.length + 1}, minmax(200px, 1fr))`; // 7 días + TODO
    ...
    <PageBreadcrumb title="Resumen venta x dia calendario" subName="Ventas" />
      ...
      <div style={{ maxHeight: 520, overflow: 'auto', border: '1px solid #eee', borderRadius: 12 }}>
              ...
              <div className="mb-2">
                ...
                >
                  {byDow.map((agg, i) => {
                    ...
                    return (
                      <div key={`${section.monthId}-dow-${i}`} style={{ padding: '8px 10px', borderRight: '1px solid #f1f1f1' }}>
                        <div className="fw-semibold mb-1 text-center bg-primary fs-3">{DAYS[i]}</div>
                        ...
                        <div className="fw-bold text-primary fs-5">% MES: {porcMes}</div>
                      </div>
                    );
                  })}

                  {/* Columna TODO del mes */}
                  <div key={`${section.monthId}-todo`} style={{ padding: '8px 10px' }}>
                    <div className="fw-semibold mb-1 text-center bg-dark text-white fs-3">TODO</div>
                    <div className="fw-bold">VENTA TOTAL: {fmtMoney(totalMes)}</div>
                    <div className="text-muted" style={{ fontSize: 12 }}>
                    ...
                    <div className="fw-bold text-primary fs-5">100.00%</div>
                  </div>
                </div>
        ...
        <div className="mt-4" style={{ padding: '12px 8px 24px' }}>
          <div className="fs-2 fw-bold text-primary mb-2 text-center">Acumulado anual por día</div>
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: GRID_SUMMARY,
          ...
          >
            {globalAgg.byDow.map((agg, i) => {
              ...
              return (
                <div key={`global-dow-${i}`} style={{ padding: '8px 10px', borderRight: '1px solid #f1f1f1' }}>
                  <div className="fw-semibold mb-1 text-center bg-primary fs-3">{DAYS[i]}</div>
                  <div className="fw-bold">VENTA TOTAL: {fmtMoney(totalDia)}</div>
                  <div className="text-muted" style={{ fontSize: 12 }}>
                    Ventas servicios: {fmtMoney(agg.ventasServicios)}
                  ...
                  <div className="fw-bold text-primary fs-5">% GLOBAL: {porcGlobal}</div>
                </div>
              );
            })}

            {/* Columna TODO global */}
            <div key="global-todo" style={{ padding: '8px 10px' }}>
              <div className="fw-semibold mb-1 text-center bg-dark text-white fs-3">acum. anual</div>
              <div className="fw-bold">VENTA TOTAL: {fmtMoney(globalAgg.total)}</div>
              <div className="text-muted" style={{ fontSize: 12 }}>
              ...
              <div className="text-muted" style={{ fontSize: 12 }}>
                Cant. servicios: {globalAgg.totales.cantidadServicios}
              </div>
              <div className="text-muted" style={{ fontSize: 12 }}>
