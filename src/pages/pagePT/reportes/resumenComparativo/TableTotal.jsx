...
export const TableTotal = ({propColor, tableColor, data, agruparPorSocios, IsVentaCero, isCanje, isTime, titleH1, isNeedGenere, labelTicketMedio='Ticket medio', avataresDeProgramas=[], arrayEstadistico=[], labelTotal, onOpenModalSOCIOS}) => {
    const { agruparPorSexo } = useGrouped()
    console.log(arrayEstadistico, "aaa");
    ...
    const estadisticas = arrayEstadistico?.map(d=>{
        ...
        { header: "clientes",  value: grupo.cantidad, tFood: grupo.cantidad },
        { header: "% clientes", isSummary: true, value: '', items: grupo.items, tFood: '' },
            ]
        }
        )
  ...
  return (
    <Card>
        ...
        <Card.Body className='d-flex justify-content-center' style={{paddingBottom: '1px !important'}}>
            <br/>
        <div  style={{width: '100%'}}>
            <FormatTable propColor={propColor} data={data} tableColor={tableColor}/>
